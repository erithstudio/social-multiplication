...
===== Request
include::{generate-source-snippets}/find-all-should-default-to-page-one-and-size-ten/http-request.adoc[]
...
===== cURL
include::{generate-source-snippets}/find-all-should-default-to-page-one-and-size-ten/curl-request.adoc[]