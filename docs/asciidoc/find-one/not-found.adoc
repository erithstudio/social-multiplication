...
include::{generate-source-snippets}/find-one-should-return-error-if-not-found/http-request.adoc[]

[[users_find_one_not_found_response]]
===== Response
include::{generate-source-snippets}/find-one-should-return-error-if-not-found/http-response.adoc[]

[[users_find_one_not_found_response_body]]
====== Response body
include::{generate-source-snippets}/find-one-should-return-error-if-not-found/response-fields.adoc[]

[[users_find_one_not_found_curl]]
===== cURL
include::{generate-source-snippets}/find-one-should-return-error-if-not-found/curl-request.adoc[]