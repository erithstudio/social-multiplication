...
include::{generate-source-snippets}/save-should-return-error-if-date-of-birth-is-in-future/http-request.adoc[]

[[users_save_date_of_birth_future_response]]
===== Response
include::{generate-source-snippets}/save-should-return-error-if-date-of-birth-is-in-future/http-response.adoc[]
...
===== cURL
include::{generate-source-snippets}/save-should-return-error-if-date-of-birth-is-in-future/curl-request.adoc[]