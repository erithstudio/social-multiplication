...
import microservices.template.multiplication.service.handler.method.IMethodHandler;
...
public class CallMethodHandler implements IMethodHandler {
    ...
    protected Method findMethod(Object m, String methodName, Class[] paramsTypes) {
